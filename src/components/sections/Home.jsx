    ...
    >
      ...
      <div className="text-center z-10 px-4">
        ...
        <p className="text-gray-400 text-lg mb-8 max-w-lg max-auto">
          I'm a full-stack Software Engineer passionate about building clean,
          scalable, and user-focused web applications. I specialize in turning
          complex problems into elegant solutions, with a strong emphasis on
        ...
        <div className="flex justify-center space-x-4">
          <a
            ...
            overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,160,246,0.4)]"
          >
            View Projects
          </a>
          <a
            ...
            transition-all duration-200 hover:shadow-[0_0_15px_rgba(59,160,246,0.2)] hover:bg-blue-500/10"
          >
            Contact Me
          </a>
        </div>
