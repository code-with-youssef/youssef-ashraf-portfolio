...
export const Projects = () => {
  ...
  hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
            >
              <h3 className="font-bold mb-3">
                Haraj Syria – Classified Ads Platform (Live in Production)
              </h3>

              <p className="text-gray-400">
                A full-scale classified ads ecosystem built with a modular, layered backend
                architecture and a modern Next.js frontend. The platform supports
                city/area-based listings, dynamic custom fields per category, advanced
                filtering, media uploads, OTP authentication, and a full admin panel for
                managing users, ads, reports, and categories. Delivered as a
                production-ready system with RESTful APIs powering both the web platform
  ...
  hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
            >
              <h3 className="font-bold mb-3">
                Sales Representatives POS System (Legacy Refactor & Full Frontend Rebuild)
              </h3>

              <p className="text-gray-400">
                A full-featured POS system built for sales representatives, handling sales
                invoices, returns, supplies, collections, and trip management workflows.
                The project was originally based on legacy code; a second version was
                created by refactoring and improving the existing backend logic while
                rebuilding the entire frontend from scratch. The system supports product
                and category management, trip creation and closure, financial tracking,
                and operational reporting, resulting in a more maintainable and scalable
                solution.
              </p>
  ...
  hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
            >
              <h3 className="font-bold mb-3">
                License Activation Management System (Backend & APIs)
              </h3>

              <p className="text-gray-400">
                Backend system built for a mobile application that generates and manages
                activation codes for a licensed software product. The system supports
                multi-branch and multi-workstation structures, secure license key
                generation, and user-based API access. An advanced admin panel was built
                using Filament to manage licenses, branches, workstations, logs,
                notifications, and detailed reports, ensuring full control and visibility
